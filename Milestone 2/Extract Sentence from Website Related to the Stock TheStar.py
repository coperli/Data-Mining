...
for company_code in companies_codes:
    ...
    connection = pymysql.connect(host='localhost', user='root', password='see26288', db='KLSE')
    cursor = connection.cursor()
    query = "SELECT `weblink` FROM `news_announcement_links` where  `main_site` = 'https://www.thestar.com.my' and  `stock_code` = "
    ...
    for weblink in weblinks:
        weblink = weblink[0]
        print(weblink)
        main_site = 'https://www.thestar.com.my/business/marketwatch/stocks/?qcounter='
